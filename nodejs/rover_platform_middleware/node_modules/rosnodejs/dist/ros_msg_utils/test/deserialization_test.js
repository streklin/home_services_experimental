...
var deserialize = require('../lib/base_deserialize.js');
var BN = require('bn.js');

describe('Deserialization Tests', function () {
  it('Uint8', function () {
  ...
  it('Uint64', function () {
    ...
    var bignums = [new BN('9223372036854775807'), new BN('18446744073709551615'), new BN('123'), new BN('8080808080')];
  ...
  it('Uint64 Array', function () {
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.uint64(buf, bufferOffset, -1);
  ...
  it('Int64', function () {
    var buf = Buffer.alloc(32);
    var numbers = ['9223372036854775807', '-9223372036854775807', '123456789', '-987654321'];
    var bignums = numbers.map(function (num) {
      return new BN(num);
    });
  ...
  it('Int64 Array', function () {
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.int64(buf, bufferOffset, 2);
    expect(arr[0].eq(bignums[0])).to.be.true;
    expect(arr[1].eq(bignums[1])).to.be.true;
  ...
  it('Float32 Array', function () {
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.float32(buf, bufferOffset, 2);
    expect(bufferOffset[0]).to.equal(8);
    expect(arr.length).to.equal(2);
  ...
  it('Float64 Array', function () {
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.float64(buf, bufferOffset, 2);
    expect(bufferOffset[0]).to.equal(16);
    expect(arr.length).to.equal(2);
  ...
  it('Time', function () {
    ...
    var times = [{ secs: 0, nsecs: 0 }, { secs: 32768, nsecs: 215888 }, { secs: 5489, nsecs: 5653 }, { secs: 81232, nsecs: 121 }];
  ...
  it('Time Array', function () {
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.time(buffer, bufferOffset, 3);
    expect(bufferOffset[0]).to.equal(24);
    expect(arr.length).to.equal(3);
  ...
  it('Duration Array', function () {
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.duration(buffer, bufferOffset, 3);
    expect(bufferOffset[0]).to.equal(24);
    expect(arr.length).to.equal(3);
    expect(arr[0]).to.deep.equal(times[0]);
    expect(arr[1]).to.deep.equal(times[1]);
  ...
  it('String Array', function () {
    ...
    var strings = ["Hello", "World", "一番", "Strings", "here", "019283dlakjsd"];
    ...
    var bufferOffset = [0];
    var arr = deserialize.Array.string(buf, bufferOffset, 2);
    expect(bufferOffset[0]).to.equal(18);
    expect(arr.length).to.equal(2);
