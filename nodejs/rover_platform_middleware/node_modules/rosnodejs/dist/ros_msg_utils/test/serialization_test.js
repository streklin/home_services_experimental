...
var serialize = require('../lib/base_serialize.js');
...
describe('Serialization Tests', function () {
  ...
  it('Uint8 Array', function () {
    var buffer = Buffer.alloc(14);
    var compBuf = Buffer.alloc(14);
  ...
  it('Uint16 Array', function () {
    var buffer = Buffer.alloc(18);
    var compBuf = Buffer.alloc(18);
  ...
  it('Uint32', function () {
    ...
    var compBuffer = Buffer.alloc(16);
  ...
  it('Uint32 Array', function () {
    var buffer = Buffer.alloc(16);
    var compBuf = Buffer.alloc(16);
  ...
  it('Uint64', function () {
    ...
    var compBuf = Buffer.alloc(32);
    var bignums = [new BN('9223372036854775807'), new BN('18446744073709551615'), new BN('123'), new BN('808080808080')];
    var buffers = [Buffer.from('ffffffffffffff7f', 'hex'), Buffer.from('ffffffffffffffff', 'hex'), Buffer.from('7b00000000000000', 'hex'), Buffer.from('90985e25bc000000', 'hex')];
  ...
  it('Uint64 Array', function () {
    var buffer = Buffer.alloc(36);
    var compBuf = Buffer.alloc(36);
    var bignums = [new BN('9223372036854775807'), new BN('18446744073709551615'), new BN('123'), new BN('808080808080')];
    var buffers = [Buffer.from('ffffffffffffff7f', 'hex'), Buffer.from('ffffffffffffffff', 'hex'), Buffer.from('7b00000000000000', 'hex'), Buffer.from('90985e25bc000000', 'hex')];
  ...
  it('Int64', function () {
    var buffer = Buffer.alloc(32);
    var compBuf = Buffer.alloc(32);
    var bignums = [new BN('9223372036854775807'), new BN('-9223372036854775807'), new BN('123456789'), new BN('-987654321')];
    var bufs = [Buffer.from('ffffffffffffff7f', 'hex'), Buffer.from('0100000000000080', 'hex'), Buffer.from('15cd5b0700000000', 'hex'), Buffer.from('4f9721c5ffffffff', 'hex')];
  ...
  it('Time Array', function () {
    var buffer = Buffer.alloc(28);
    var compBuf = Buffer.alloc(28);
  ...
  it('String Array', function () {
    var buffer = Buffer.alloc(47);
    var compBuf = Buffer.alloc(47);
