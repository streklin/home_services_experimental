...
var getByteLength = require('./encoding_utils.js').getByteLength;
...
function DefaultArraySerializer(serializeFunc, array, buffer, bufferOffset) {
  var specArrayLen = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
...
function UInt8ArraySerializer(array, buffer, bufferOffset) {
  var specArrayLen = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
